...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        # Plot images
        if batch_i < 100:
            f = 'res-images2/test_batch%g_gt.jpg' % batch_i  # filename
            plot_images(img, targets, paths, f, names)  # ground truth
            f = 'res-images2/test_batch%g_pred.jpg' % batch_i
    ...
    if save_json and map50 and len(jdict):
        imgIds = [os.path.splitext(x)[0]for x in dataloader.dataset.img_files]
