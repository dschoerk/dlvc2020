    ...
    try:
        for epoch in range(opt.num_epochs):
            ...
            if epoch % opt.val_interval == 0:
                ...
                writer.add_scalars('Val Loss', {'val': loss}, step)
                writer.add_scalars('Val Regression_loss', {'val': reg_loss}, step)
                writer.add_scalars('Val Classfication_loss', {'val': cls_loss}, step)
